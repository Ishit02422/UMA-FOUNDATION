                      ...
                      <ul class="nav">
                          ...
                          <li class="has-sub">
                              ...
                              <ul class="sub-menu">
                                  ...
                                  <li><a href="scholarship.php">Meeting Details</a></li>
                              </ul>
                          </li>
            ...
            <div class="col-lg-12">
              <div class="meeting-single-item">
                <div class="thumb">
                  ...
                  <a href="scholarship.php"><img src="assets/images/single-meeting.jpg" alt=""></a>
                </div>
                <div class="down-content">
                  <a href="scholarship.php"><h4>Online Teaching and Learning Tools</h4></a>
